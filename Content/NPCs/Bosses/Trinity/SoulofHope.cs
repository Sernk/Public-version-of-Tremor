...
namespace TremorMod.Content.NPCs.Bosses.Trinity
{
	...
	public class SoulofHope : ModNPC
	{
        ...
        public override void ModifyNPCLoot(NPCLoot npcLoot)
        {
            if (!NPC.AnyNPCs(ModContent.NPCType<SoulofTruth>()) && !NPC.AnyNPCs(ModContent.NPCType<SoulofTrust>()))
			{
				npcLoot.Add(ItemDropRule.Common(ModContent.ItemType<HopeMask>(), 7));
				npcLoot.Add(ItemDropRule.Common(ModContent.ItemType<Banhammer>(), 3));
				npcLoot.Add(ItemDropRule.Common(ModContent.ItemType<BestNightmare>(), 3));
