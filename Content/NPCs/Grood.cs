...
namespace TremorMod.Content.NPCs
{
	public class Grood : ModNPC
	{
        ...
        {
            npcLoot.Add(ItemDropRule.ByCondition(new Conditions.NotExpert(), ModContent.ItemType<YellowPuzzleFragment>(), 23));
            npcLoot.Add(ItemDropRule.ByCondition(new Conditions.NotExpert(), ModContent.ItemType<RedFeather>(), 30));
        }
        ...
        public override void HitEffect(NPC.HitInfo hit)
		{
            ...
            if (NPC.life <= 0)
			{
                ...
                Gore.NewGore(NPC.GetSource_Death(), NPC.position, NPC.velocity, Mod.Find<ModGore>("GroodGore").Type, 1f);
