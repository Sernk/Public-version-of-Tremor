	...
	public class Deadling1 : ModNPC
	{
        ...
        public override void ModifyNPCLoot(NPCLoot npcLoot)
        {
            if (Main.netMode != 1)
            {
                ...
                npcLoot.Add(ItemDropRule.ByCondition(new Conditions.NotExpert(), ItemID.Heart, 40)); 
                npcLoot.Add(ItemDropRule.ByCondition(new Conditions.NotExpert(), ItemID.Cobweb, 10, 2, 3)); 
                npcLoot.Add(ItemDropRule.ByCondition(new Conditions.NotExpert(), ItemID.Star, 12)); 
                npcLoot.Add(ItemDropRule.ByCondition(new Conditions.NotExpert(), ModContent.ItemType<RottenHand>(), 40));
            }
        }
    }
}